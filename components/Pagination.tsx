  ...
  return (
    ...
    <nav aria-label="pagination" className="mx-auto  my-20 container">
      ...
      <ul className="mx-auto flex justify-center -space-x-px">
        <li>
          <a href="#" className="px-3 py-2 mr-2 border border-transparent rounded-md  leading-tight bg-white hover:text-blue-700 dark:bg-gray-800 dark:text-gray-400
        ...
        <li>
          <a href="#" className="px-3 py-2 ml-2  border border-transparent rounded-md leading-tight bg-white hover:text-blue-700 dark:bg-gray-800 dark:text-gray-400
